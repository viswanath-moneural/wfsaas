...
export default async function ElementScreenDesignsPage({ params }: { params: Promise<{ elementId: string }> }) {
  ...
  return <ElementDetailShell detail={{ ...detailResult.data, allElements: elementsResult.data ?? [] }} section="screen-designs" />
}
