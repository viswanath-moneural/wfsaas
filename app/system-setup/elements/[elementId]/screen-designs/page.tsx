...
export default async function ElementScreenDesignsPage({ params, searchParams }: { params: Promise<{ elementId: string }>; searchParams: Promise<{ businessUnitId?: string }> }) {
  ...
  return <ElementDetailShell detail={{ ...detailResult.data, allElements: elementsResult.data ?? [] }} section="screen-designs" selectedBusinessUnitId={search.businessUnitId ?? null} />
}
