...
export default async function ElementDataRulesPage({ params }: { params: Promise<{ elementId: string }> }) {
  ...
  return <ElementDetailShell detail={{ ...detailResult.data, allElements: elementsResult.data ?? [] }} section="data-rules" />
}
