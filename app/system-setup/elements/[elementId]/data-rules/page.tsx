...
export default async function ElementDataRulesPage({ params, searchParams }: { params: Promise<{ elementId: string }>; searchParams: Promise<{ businessUnitId?: string }> }) {
  ...
  return <ElementDetailShell detail={{ ...detailResult.data, allElements: elementsResult.data ?? [] }} section="data-rules" selectedBusinessUnitId={search.businessUnitId ?? null} />
}
