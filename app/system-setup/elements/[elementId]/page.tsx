...
export default async function ElementOverviewPage({
  params,
  searchParams,
}: {
  ...
  return <ElementDetailShell detail={{ ...detailResult.data, allElements: elementsResult.data ?? [] }} section="overview" selectedBusinessUnitId={search.businessUnitId ?? null} />
}
