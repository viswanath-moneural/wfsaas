...
export default async function ElementOverviewPage({ params }: { params: Promise<{ elementId: string }> }) {
  ...
  return <ElementDetailShell detail={{ ...detailResult.data, allElements: elementsResult.data ?? [] }} section="overview" />
}
