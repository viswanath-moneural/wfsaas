...
export default async function ElementDataBondsPage({ params }: { params: Promise<{ elementId: string }> }) {
  ...
  return <ElementDetailShell detail={{ ...detailResult.data, allElements: elementsResult.data ?? [] }} section="data-bonds" />
}
