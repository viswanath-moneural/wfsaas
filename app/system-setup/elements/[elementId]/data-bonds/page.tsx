...
export default async function ElementDataBondsPage({ params, searchParams }: { params: Promise<{ elementId: string }>; searchParams: Promise<{ businessUnitId?: string }> }) {
  ...
  return <ElementDetailShell detail={{ ...detailResult.data, allElements: elementsResult.data ?? [] }} section="data-bonds" selectedBusinessUnitId={search.businessUnitId ?? null} />
}
